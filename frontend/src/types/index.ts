...
export interface GridResult { orders: GridOrder[]; tradeCount: number; finalEquity: number; totalProfit: number; returnRate: number; sharpeRatio: number; maxDrawdown: number; winRate: number; equityCurve: number[] }
